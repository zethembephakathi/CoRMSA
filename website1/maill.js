...
function submitForm(e) {
  ...
  if (validateInputs(name, emailid, sub, msgContent)) {
    // If inputs are valid, save the form data
    saveMessages(name, emailid,sub, msgContent);
...
const validateInputs = (name, emailid, sub ,msgContent) => {
  // Simple validation, you can enhance this as needed
  if (!name || !emailid ||!sub || !msgContent) {
...
const saveMessages = (name, emailid,sub, msgContent) => {
